use vector2::{Vector2, Vector2Index};
...
pub mod cardinal_directions {
    use vector2::Vector2Index;
    use super::{CardinalDirectionProfile, CardinalDirection};
...
pub mod ordinal_directions {
    ...
    use super::{OrdinalDirectionProfile, OrdinalDirection};
...
pub struct DirectionIter(usize);
...
pub fn direction_iter() -> DirectionIter {
    DirectionIter(0)
}
