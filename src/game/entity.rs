use game::{EntityWrapper, Component, ComponentType};

use table::{TableId, Table, TableTable, InvertedTableRef, InvertedTableRefMut, InvertedTableTable,
            TableRef, IterTableRef, TableRefMut, IdTableRef};
...
pub trait IterEntityRef<'a>
    : IterTableRef<'a, ComponentType, Component> + EntityRef<'a> {
}
pub trait EntityRefMut<'a>: TableRefMut<'a, ComponentType, Component> {}
pub trait IdEntityRef<'a>
    : IdTableRef<'a, ComponentType, Component> + IterEntityRef<'a> {
}
